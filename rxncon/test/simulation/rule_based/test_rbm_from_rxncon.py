...
def test_simple_rxncon_system(simple_system):
    ...
    print(mol_def_X.match_with_state_set(venn.PropertySet(rfs.state_from_string('X-{p}'))))
...
def simple_system():
    ...
    reactions = [phosphorylation_reaction_1, phosphorylation_reaction_2, binding_reaction]
