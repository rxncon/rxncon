...
def is_rule_test_case_correct(test_case) -> bool:
    ...
    actual_mol_defs = RuleBasedModelSupervisor(rxncon).mol_defs.values()
    ...
    return set(actual_mol_defs) == set(expected_mol_defs) and are_rule_lists_equivalent(actual_rules, expected_rules)
