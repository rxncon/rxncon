...
def test_string_from_complex_reactant(simple_molecule_spec):
    ...
    complex_reactant = rbm.ComplexReactant(
            ...
            [rxncon.simulation.rule_based.rule_based_model.Binding(left_partner=(0, bound_molecule_a.association_specs[0]), right_partner=(1, bound_molecule_b.association_properties[0]))]
    )
...
def simple_rule_based_model():
    ...
    binding = rxncon.simulation.rule_based.rule_based_model.Binding((0, mol_spec_a_bound.association_properties[0]),
