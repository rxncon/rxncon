...
def is_graph_test_case_correct(test_case) -> bool:
    ...
    #gml_system.to_file('/home/thiemese/project/rxncon/graphml/test.xgmml')
    ...
    [expected_graph.add_node(node.split('#NOT')[0], type=reg.NodeType.NOT.value) for node in test_case.boolean_state_node_strings if '#NOT' in node]
