...
#                                        }),
#
#                          [rxn.Reactant(spec.ProteinSpecification('A', 0, spec.DomainDefinition(None, None, None)),
#                                        []),
#                           rxn.Reactant(spec.ProteinSpecification('B', 1, spec.DomainDefinition(None, None, None)),
...
#             #                  ),
#
#         ReactionTestCase('A@0_trsc_B@1',
#                          reaction_definitions['transcription'],
#                          rxn.Reaction(reaction_definitions['transcription'],
#                                       {'$x': rxn.specification_from_string('A@0'),
#                                        '$y': rxn.specification_from_string('B@1')
#                                        }),
#                          [rxn.Reactant(spec.ProteinSpecification('A', 0, spec.DomainDefinition(None, None, None)),
#                                        []),
#                           rxn.Reactant(spec.DnaSpecification('B', 1, spec.DomainDefinition(None, None, None)),
#                                        [])],
#
#                          [rxn.Reactant(spec.ProteinSpecification('A', 0, spec.DomainDefinition(None, None, None)),
#                                        []),
#                           rxn.Reactant(spec.DnaSpecification('B', 1, spec.DomainDefinition(None, None, None)),
#                                        []),
#                           rxn.Reactant(spec.RnaSpecification('B', 1, spec.DomainDefinition(None, None, None)),
#                                        [])],
#
#                          ),
#
#         ReactionTestCase('A@0_trsl_B@1',
#                          reaction_definitions['translation'],
#                          rxn.Reaction(reaction_definitions['translation'],
#                                       {'$x': rxn.specification_from_string('A@0'),
#                                        '$y': rxn.specification_from_string('B@1')
#                                        }),
#                          [rxn.Reactant(spec.ProteinSpecification('A', 1, spec.DomainDefinition(None, None, None)),
#                                        []),
#                           rxn.Reactant(spec.RnaSpecification('B', 1, spec.DomainDefinition(None, None, None)),
#                                        [])],
#
